...
{
    static NSMutableDictionary *registeredRequestBuildersSingleton = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        registeredRequestBuildersSingleton = [[NSMutableDictionary alloc] init];
    });
    return registeredRequestBuildersSingleton;
}
...
+ (void)registerRequestBuilder:(Class)requestBuilderClass
{
    ...
    {
        TGLog(@"Error: ASActor::registerRequestBuilder: genericPath is nil");
        return;
    }
