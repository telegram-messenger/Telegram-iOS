...
@synthesize crop_width = _crop_width;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.crop_left = metaObject->getDouble(0x47270b7f);
    object.crop_top = metaObject->getDouble(0x804ef5cc);
    object.crop_width = metaObject->getDouble(0x2bd4155b);
    return object;
}
...
{
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x47270b7f, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypePrimitiveDouble;
        value.primitive.doubleValue = self.crop_top;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x804ef5cc, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypePrimitiveDouble;
        value.primitive.doubleValue = self.crop_width;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x2bd4155b, value));
    }
}
