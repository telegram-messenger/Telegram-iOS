...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.msg_ids = metaObject->getArray(0x56f5f04c);
    object.info = metaObject->getString(0x3928e0e2);
    return object;
}
...
{
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x56f5f04c, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeString;
        value.nativeObject = self.info;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x3928e0e2, value));
    }
}
