...
@synthesize random_length = _random_length;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.random_length = metaObject->getInt32(0x5b2b3b4b);
    return object;
}
...
- (void)TLfillFieldsWithValues:(std::map<int32_t, TLConstructedValue> *)values
{
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x5b2b3b4b, value));
    }
}
