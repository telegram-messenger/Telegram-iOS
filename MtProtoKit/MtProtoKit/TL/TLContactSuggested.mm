...
@synthesize mutual_contacts = _mutual_contacts;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.mutual_contacts = metaObject->getInt32(0xc8ba8f61);
    return object;
}
...
- (void)TLfillFieldsWithValues:(std::map<int32_t, TLConstructedValue> *)values
{
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0xc8ba8f61, value));
    }
}
