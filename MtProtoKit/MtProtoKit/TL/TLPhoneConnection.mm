...
@synthesize stream_id = _stream_id;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.server = metaObject->getString(0x3bc2f529);
    object.port = metaObject->getInt32(0x81ce65c9);
    object.stream_id = metaObject->getInt64(0x736c1b31);
    return object;
}
...
{
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x3bc2f529, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypePrimitiveInt32;
        value.primitive.int32Value = self.port;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x81ce65c9, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypePrimitiveInt64;
        value.primitive.int64Value = self.stream_id;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x736c1b31, value));
    }
}
