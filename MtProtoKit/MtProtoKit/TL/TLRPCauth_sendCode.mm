...
@synthesize sms_type = _sms_type;
@synthesize api_id = _api_id;
@synthesize api_hash = _api_hash;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.sms_type = metaObject->getInt32(0x81989b48);
    object.api_id = metaObject->getInt32(0x658ffe92);
    object.api_hash = metaObject->getString(0x868d53ee);
...
- (void)TLfillFieldsWithValues:(std::map<int32_t, TLConstructedValue> *)values
{
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x81989b48, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypePrimitiveInt32;
        value.primitive.int32Value = self.api_id;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x658ffe92, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeString;
        value.nativeObject = self.api_hash;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x868d53ee, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeString;
