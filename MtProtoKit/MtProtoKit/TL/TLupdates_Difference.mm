...
@synthesize n_new_messages = _n_new_messages;
@synthesize n_new_encrypted_messages = _n_new_encrypted_messages;
@synthesize other_updates = _other_updates;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.n_new_messages = metaObject->getArray(0xe7cf9f7c);
    object.n_new_encrypted_messages = metaObject->getArray(0xff8a59e6);
    object.other_updates = metaObject->getArray(0x91aa7dcd);
    object.chats = metaObject->getArray(0x4240ad02);
    object.users = metaObject->getArray(0x933e5ff3);
    object.state = metaObject->getObject(0x449b9b4e);
    return object;
}
...
{
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0xe7cf9f7c, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeVector;
        value.nativeObject = self.n_new_encrypted_messages;
        values->insert(std::pair<int32_t, TLConstructedValue>(0xff8a59e6, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeVector;
        value.nativeObject = self.other_updates;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x91aa7dcd, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeVector;
...
@synthesize chats = _chats;
@synthesize users = _users;
@synthesize intermediate_state = _intermediate_state;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.chats = metaObject->getArray(0x4240ad02);
    object.users = metaObject->getArray(0x933e5ff3);
    object.intermediate_state = metaObject->getObject(0xc976b11c);
    return object;
}
...
- (void)TLfillFieldsWithValues:(std::map<int32_t, TLConstructedValue> *)values
{
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0xc976b11c, value));
    }
}
