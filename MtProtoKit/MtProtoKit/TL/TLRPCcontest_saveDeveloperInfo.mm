...
{
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x1414258e, value));
    }
    {
        TLConstructedValue value;
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0xbadfeedd, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeString;
