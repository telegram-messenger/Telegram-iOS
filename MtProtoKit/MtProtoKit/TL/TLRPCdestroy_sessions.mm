...
@synthesize session_ids = _session_ids;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.session_ids = metaObject->getObject(0xf0896a48);
    return object;
}
...
{
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0xf0896a48, value));
    }
}
