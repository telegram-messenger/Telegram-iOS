...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.update = metaObject->getObject(0x88b36c62);
    object.date = metaObject->getInt32(0xb76958ba);
    return object;
}
...
{
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x88b36c62, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypePrimitiveInt32;
...
@synthesize date = _date;
@synthesize seq_start = _seq_start;
@synthesize seq = _seq;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.updates = metaObject->getArray(0x9ae046f4);
    object.users = metaObject->getArray(0x933e5ff3);
    object.chats = metaObject->getArray(0x4240ad02);
    object.date = metaObject->getInt32(0xb76958ba);
    object.seq_start = metaObject->getInt32(0x4cae688b);
    object.seq = metaObject->getInt32(0xc769ed79);
    return object;
}
...
{
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x9ae046f4, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeVector;
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x4cae688b, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypePrimitiveInt32;
