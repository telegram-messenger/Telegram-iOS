...
@synthesize mute_until = _mute_until;
@synthesize sound = _sound;
@synthesize show_previews = _show_previews;
@synthesize events_mask = _events_mask;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.mute_until = metaObject->getInt32(0xb47c7399);
    object.sound = metaObject->getString(0x352fa0b9);
    object.show_previews = metaObject->getBool(0xccc87c93);
    object.events_mask = metaObject->getInt32(0x76f7fd23);
    return object;
}
...
{
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0xb47c7399, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeString;
        value.nativeObject = self.sound;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x352fa0b9, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypePrimitiveBool;
        value.primitive.boolValue = self.show_previews;
        values->insert(std::pair<int32_t, TLConstructedValue>(0xccc87c93, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypePrimitiveInt32;
        value.primitive.int32Value = self.events_mask;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x76f7fd23, value));
    }
}
