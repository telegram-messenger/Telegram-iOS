...
@synthesize valid_since = _valid_since;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.valid_since = metaObject->getInt32(0xe0edebd2);
    object.valid_until = metaObject->getInt32(0x46f4d603);
    object.salt = metaObject->getInt64(0x9cda6869);
    return object;
}
...
{
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0xe0edebd2, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypePrimitiveInt32;
        value.primitive.int32Value = self.valid_until;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x46f4d603, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypePrimitiveInt64;
        value.primitive.int64Value = self.salt;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x9cda6869, value));
    }
}
