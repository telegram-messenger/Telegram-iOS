...
@synthesize n_new_nonce_hash = _n_new_nonce_hash;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.n_new_nonce_hash = metaObject->getBytes(0x5568335a);
    return object;
}
...
- (void)TLfillFieldsWithValues:(std::map<int32_t, TLConstructedValue> *)values
{
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x5568335a, value));
    }
}
...
@synthesize encrypted_answer = _encrypted_answer;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.nonce = metaObject->getBytes(0x48cbe731);
    object.server_nonce = metaObject->getBytes(0xe1dc3f2c);
    object.encrypted_answer = metaObject->getBytes(0xbdd67186);
    return object;
}
...
- (void)TLfillFieldsWithValues:(std::map<int32_t, TLConstructedValue> *)values
{
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0xbdd67186, value));
    }
}
