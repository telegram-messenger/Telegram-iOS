...
@synthesize g = _g;
@synthesize p = _p;
@synthesize ring_timeout = _ring_timeout;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.p = metaObject->getString(0xb91d8925);
    object.ring_timeout = metaObject->getInt32(0x3cc578d1);
...
- (void)TLfillFieldsWithValues:(std::map<int32_t, TLConstructedValue> *)values
{
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x3cc578d1, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypePrimitiveInt32;
