...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.predicate = metaObject->getString(0x5b3a3e46);
    object.params = metaObject->getArray(0xb58ba8a1);
...
- (void)TLfillFieldsWithValues:(std::map<int32_t, TLConstructedValue> *)values
{
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x5b3a3e46, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeVector;
        value.nativeObject = self.params;
        values->insert(std::pair<int32_t, TLConstructedValue>(0xb58ba8a1, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeString;
