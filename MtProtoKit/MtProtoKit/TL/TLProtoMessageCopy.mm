...
@synthesize orig_message = _orig_message;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.orig_message = metaObject->getObject(0x62cb891c);
    return object;
}
...
{
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x62cb891c, value));
    }
}
