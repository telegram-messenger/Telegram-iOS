...
@synthesize scheme_raw = _scheme_raw;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.scheme_raw = metaObject->getString(0x595f3bb0);
    object.types = metaObject->getArray(0x32251ae0);
    object.methods = metaObject->getArray(0x6a1783c2);
...
{
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x595f3bb0, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeVector;
        value.nativeObject = self.types;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x32251ae0, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeVector;
        value.nativeObject = self.methods;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x6a1783c2, value));
    }
    {
        TLConstructedValue value;
