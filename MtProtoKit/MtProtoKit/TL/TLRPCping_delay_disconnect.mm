...
@synthesize ping_id = _ping_id;
@synthesize disconnect_delay = _disconnect_delay;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.ping_id = metaObject->getInt64(0x357f0145);
    object.disconnect_delay = metaObject->getInt32(0x10283039);
    return object;
}
...
{
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x357f0145, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypePrimitiveInt32;
        value.primitive.int32Value = self.disconnect_delay;
        values->insert(std::pair<int32_t, TLConstructedValue>(0x10283039, value));
    }
}
