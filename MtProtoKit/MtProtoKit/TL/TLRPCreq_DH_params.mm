...
@synthesize p = _p;
@synthesize q = _q;
@synthesize public_key_fingerprint = _public_key_fingerprint;
@synthesize encrypted_data = _encrypted_data;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.public_key_fingerprint = metaObject->getInt64(0x9a3a505d);
    object.encrypted_data = metaObject->getBytes(0xd9c47df7);
    return object;
}
...
- (void)TLfillFieldsWithValues:(std::map<int32_t, TLConstructedValue> *)values
{
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x9a3a505d, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeBytes;
        value.nativeObject = self.encrypted_data;
        values->insert(std::pair<int32_t, TLConstructedValue>(0xd9c47df7, value));
    }
}
