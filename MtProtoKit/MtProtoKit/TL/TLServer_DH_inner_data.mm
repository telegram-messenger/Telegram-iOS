...
@synthesize g = _g;
@synthesize dh_prime = _dh_prime;
@synthesize g_a = _g_a;
@synthesize server_time = _server_time;
...
- (id<TLObject>)TLbuildFromMetaObject:(std::tr1::shared_ptr<TLMetaObject>)metaObject
{
    ...
    object.g = metaObject->getInt32(0x75e1067a);
    object.dh_prime = metaObject->getBytes(0xbd796e8b);
    object.g_a = metaObject->getBytes(0xa6887fe5);
    object.server_time = metaObject->getInt32(0x5dcc0dd1);
    return object;
}
...
- (void)TLfillFieldsWithValues:(std::map<int32_t, TLConstructedValue> *)values
{
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x75e1067a, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeBytes;
        value.nativeObject = self.dh_prime;
        values->insert(std::pair<int32_t, TLConstructedValue>(0xbd796e8b, value));
    }
    {
        TLConstructedValue value;
        value.type = TLConstructedValueTypeBytes;
    ...
    }
    {
        ...
        values->insert(std::pair<int32_t, TLConstructedValue>(0x5dcc0dd1, value));
    }
}
